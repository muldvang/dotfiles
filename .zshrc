...
RPROMPT="%{$fg[red]%}%n%{$reset_color%}@%{$fg[green]%}%m%{$reset_color%}"
PROMPT='%{$fg[blue]%}%3~ %{$reset_color%}$(git_super_status)%# '

# Change directory without using the cd command
setopt AUTO_CD
