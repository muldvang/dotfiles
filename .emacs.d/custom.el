(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (jira-markup-mode groovy-mode diminish yard-mode json-mode web-mode which-key smart-mode-line-powerline-theme smart-mode-line telephone-line auto-compile use-package htmlize ox-twbs evil-numbers kotlin-mode smex smartparens scala-mode rainbow-mode rainbow-delimiters powerline pkgbuild-mode markdown-mode ido-vertical-mode ido-ubiquitous hungry-delete god-mode flycheck-color-mode-line flx-ido fish-mode fill-column-indicator feature-mode expand-region dtrt-indent diff-hl company-quickhelp company-math company-irony company-emacs-eclim company-anaconda cmake-mode benchmark-init auto-indent-mode auctex adaptive-wrap)))
